...
if ($id) {
    ...
    if($stmt){
        ...
        if ($result->num_rows > 0) {
            ...
            header('Location: ' . ADMIN_URL . '/hero_sliders.php');
            exit;
        }
        $stmt->close();
    } else {
            ...
            <div class="card shadow">
                 <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo ADMIN_URL; ?>/hero_sliders.php" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body pt-0">
                    ...
                    <form action="<?php echo ADMIN_URL; ?>/hero_slider_actions.php" method="POST" class="mt-3">
                        ...
                        <div class="mt-4 pt-3 border-top">
                            ...
                            <a href="<?php echo ADMIN_URL; ?>/hero_sliders.php" class="btn btn-secondary btn-lg">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
