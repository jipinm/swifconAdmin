...
$menu_items = [
    ...
    'About' => [ // Parent Menu Item
        ...
        'title' => 'About Us',
        'submenu' => [
             'about_content_edit.php' => ['icon' => 'bi-text-paragraph', 'title' => 'About Content'],
             'our_journey_list.php' => ['icon' => 'bi-signpost-split-fill', 'title' => 'Our Journey'],
             'our_values_list.php' => ['icon' => 'bi-gem', 'title' => 'Our Values'],
        ]
    ],
    'testimonials_list.php' => ['icon' => 'bi-chat-square-quote-fill', 'title' => 'Testimonials'],
