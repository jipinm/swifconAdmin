    ...
    <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
            <?php foreach ($menu_items as $url => $item): ?>
                        ...
                        <div class="collapse <?php echo ($parent_page == $url) ? 'show' : ''; ?>" id="<?php echo str_replace(' ', '', $url); ?>Submenu">
                            <ul class="nav flex-column ms-3">
                                <?php foreach ($item['submenu'] as $sub_url => $sub_item): ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo ($current_page == $sub_url) ? 'active' : ''; ?>" href="<?php echo ADMIN_URL . '/' . $sub_url; ?>">
                ...
                <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($current_page == $url) ? 'active' : ''; ?>" href="<?php echo ADMIN_URL . '/' . $url; ?>">
                            <i class="bi <?php echo $item['icon']; ?>"></i>
