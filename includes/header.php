...
<?php if (is_logged_in()): ?>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top p-0 shadow">
        <div class="container-fluid">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="<?php echo ADMIN_URL; ?>/dashboard.php">
                ...
                <ul class="navbar-nav ms-auto px-3">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="<?php echo ADMIN_URL; ?>/logout.php"><i class="bi bi-box-arrow-right"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
