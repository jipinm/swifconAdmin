            ...
            <div class="card shadow">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo SITE_URL; ?>/hero_slider_form.php" class="btn btn-primary">
                                    ...
                                    <?php foreach ($sliders as $index => $slider): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo SITE_URL; ?>/hero_slider_form.php?id=<?php echo $slider['id']; ?>" class="btn btn-sm btn-info me-1" title="Edit">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <a href="<?php echo SITE_URL; ?>/hero_slider_actions.php?action=toggle_status&id=<?php echo $slider['id']; ?>"
                                                ...
                                                <a href="<?php echo SITE_URL; ?>/hero_slider_actions.php?action=delete&id=<?php echo $slider['id']; ?>"
