...
$entry_data = [
    'id' => null, 'year' => date('Y'), 'title' => '', 'subtitle' => '',
    'sort_order' => 0, 'status' => 'active'
];
$form_action_label = 'Add New';

if ($id) {
    $page_title = 'Edit Journey Entry';
    $form_action_label = 'Edit';
    $stmt = $conn->prepare("SELECT * FROM our_journey WHERE id = ?");
    if($stmt){
        ...
        if ($result->num_rows > 0) {
            ...
            $_SESSION['error_message'] = "Journey entry not found with ID: $id.";
            header('Location: ' . SITE_URL . '/our_journey_list.php');
            exit;
        }
        $stmt->close();
    } else {
        $_SESSION['error_message'] = "Database error preparing to fetch journey entry: " . $conn->error;
        header('Location: ' . SITE_URL . '/our_journey_list.php');
        exit;
    }
} else {
    $page_title = 'Add New Journey Entry';
}
            ...
            <div class="card shadow">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo SITE_URL; ?>/our_journey_list.php" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body pt-0">
                    ...
                    <form action="<?php echo SITE_URL; ?>/our_journey_actions.php" method="POST" class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="year" name="year" value="<?php echo htmlspecialchars($entry_data['year']); ?>" required placeholder="e.g., 2023 or Q1 2023">
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top">
                            ...
                            <a href="<?php echo SITE_URL; ?>/our_journey_list.php" class="btn btn-secondary btn-lg">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
